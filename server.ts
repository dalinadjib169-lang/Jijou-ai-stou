...
6. المنهاج والرياضيات والرموز: ادعم ووجه التلاميذ في جميع المواد التعليمية للمنهاج الجزائري وخصوصاً الرياضيات. اكتب الرموز الرياضية بصيغة واضحة ومفهومة ومطابقة تماماً للمنهاج المعتمد وبطريقة عربية طبيعية (مثل: 3 + 3 × 3، أو f(x) = 2x + 1). يمنع منعاً باتاً استخدام رمز الدولار ($).
